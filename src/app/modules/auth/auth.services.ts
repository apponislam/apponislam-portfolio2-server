...
const registerUser = async (data: any) => {
    ...
    sendVerificationEmail(createdUser.email as string, createdUser.fullName as string, verificationUrl);
    sendWelcomeEmail(createdUser.email as string, createdUser.fullName as string);
...
const resendVerificationEmail = async (email: string) => {
    ...
    sendVerificationEmail(user.email as string, user.fullName as string, verificationUrl);
...
const requestPasswordReset = async (email: string) => {
    ...
    // Send OTP email
    sendOtpEmail(email, otp, user.fullName as string);
...
const updateEmail = async (userId: string, newEmail: string, password: string) => {
    ...
    sendEmailUpdateVerification(newEmail, user.fullName as string, verificationUrl);
};
...
const resendEmailUpdate = async (userId: string, password: string) => {
    ...
    sendEmailUpdateVerification(user.pendingEmail as string, user.fullName as string, verificationUrl);
